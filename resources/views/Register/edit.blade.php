...
@section('title', 'রেজিস্টার আপডেট করুন')
@section('css')
    <style>
...
@section('content')
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 text-gray-800"> <i class="fa fa-pencil-alt"></i> রেজিস্টার আপডেট করুন</h4>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="number" class="form-control form-control-sm @error('building') is-invalid @enderror" name="building" step="0.01" value="{{ old('building') ?: $taxRegister->building }}" id="building">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="number" class="form-control form-control-sm @error('doa_ripe_tin_shed') is-invalid @enderror"  name="doa_ripe_tin_shed" step="0.01" value="{{ old('doa_ripe_tin_shed') ?: $taxRegister->doa_ripe_tin_shed }}" id="doa_ripe_tin_shed">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="number" class="form-control form-control-sm @error('raw_chapra') is-invalid @enderror" name="raw_chapra" step="0.01" value="{{ old('raw_chapra') ?: $taxRegister->raw_chapra }}" id="raw_chapra">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="number" class="form-control form-control-sm @error('pucca_house') is-invalid @enderror" name="pucca_house" step="0.01" value="{{ old('pucca_house') ?: $taxRegister->pucca_house }}" id="pucca_house">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control form-control-sm @error('nid_number') is-invalid @enderror" name="nid_number" value="{{ old('nid_number') ?: $taxRegister->nid_number }}" id="nid_number">
                                            @error('nid_number')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                            @enderror
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control form-control-sm @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile') ?: $taxRegister->mobile }}" id="mobile">
                                            @error('mobile')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                            @enderror
                                        ...
                                        <div>
                                            <select class="select2-single form-control" name="village" required id="village">
                                                ...
                                                @foreach($villages as $key => $value)
                                                    ...
                                                    <option {{ $taxRegister->village_id == $key ? 'selected' : '' }} value="{{ $key }}">{{ $value }}</option>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="number" class="form-control form-control-sm @error('book_no') is-invalid @enderror" name="book_no" value="{{ old('book_no') ?: $taxRegister->book_no }}" id="book_no">
                                            @error('book_no')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                            @enderror
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-10 offset-md-1">
                                    ...
                                    <table id="myTable" class="table table-bordered edu1">
                                        ...
                                        @foreach($taxRegister->taxAmount as $key => $taxAmount)
                                            <tr>
                                                <td class="serial">{{ $key+1 }}</td>
                                                <td>
                                                    <input type="hidden" name="text_amount_id[]" value="{{ $taxAmount->id }}">
                                                    <div class="input-daterange input-group">
                                                        <input type="text" class="form-control input-sm date-range" name="from_year[]" value="{{ $taxAmount->from }}" required>
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">হইতে</span>
                                                        </div>
                                                        <input type="text" class="form-control input-sm date-range" name="to_year[]" value="{{ $taxAmount->to }}" required>
                                                    </div>
                                                </td>
                                                <td><input type="number" class="form-control" name="amount_of_tax[]" value="{{ $taxAmount->amount_of_tax }}" required></td>
                                                <td>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <div class="btn-group float-right">
                                        <button type="submit" class="btn btn-dark btn-sm"><i class="fa fa-pencil-alt"></i> Update</button>
        ...
        $(document).ready(function () {
            ...
            $("#add").on("click", function () {
                ...
                cols += '<td><div class="input-daterange input-group">\n' +
                    '        <input type="text" class="form-control input-sm date-range" name="update_from_year[]" required>\n' +
                    '        <div class="input-group-prepend">\n' +
                    '            <span class="input-group-text">হইতে</span>\n' +
                    '        </div>\n' +
                    '        <input type="text" class="form-control input-sm date-range" name="update_to_year[]" required>\n' +
                    '    </div></td>';
                cols += '<td><input type="number" class="form-control" name="update_amount_of_tax[]" required ></td>';
